...
class GridVcode(QgsProcessingAlgorithm):
    EXTENT = 'EXTENT'
    PRECISION = 'PRECISION'
    OUTPUT = 'OUTPUT'
    ...
    def tags(self):
        return self.tr('Vgrid, Vcode, generator').split(',')
    ...
    def prepareAlgorithm(self, parameters, context, feedback):
        ...
        if self.precision < 0 or self.precision > 24:
            feedback.reportError('Precision parameter must be in range [0,24]')
            return False
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        # Cover the entire world extent
            tiles = list(mercantile.tiles(-180.0,-85.05112878,180.0,85.05112878,self.precision))
        else:
            ...
            tiles = list(mercantile.tiles(xmin, ymin, xmax, ymax, self.precision))
        ...
        for index, tile in enumerate(tiles):
            ...
            # Generate the 'vcode' attribute in the format "zZxXyY"
