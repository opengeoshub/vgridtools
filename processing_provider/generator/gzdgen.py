...
class GZDGen(QgsProcessingAlgorithm):
    POLAR = "POLAR"
    OUTPUT = "OUTPUT"
    ...
    def tags(self):
        return self.tr("DGGS, MGRS, GZD, generator").split(",")
    ...
    def initAlgorithm(self, config=None):
        self.addParameter(
            QgsProcessingParameterBoolean(
                self.POLAR, "Include polar regions", True, optional=False
            )
        )
        self.addParameter(QgsProcessingParameterFeatureSink(self.OUTPUT, "MGRS GZD"))
