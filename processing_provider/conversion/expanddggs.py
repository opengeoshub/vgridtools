...
from ...utils.conversion.expanddggs import * 

class ExpandDGGS(QgsProcessingFeatureBasedAlgorithm):
    INPUT = 'INPUT'
    DGGS_TYPE = 'DGGS_TYPE'
    ...
    def displayName(self):
        return self.tr('Expand DGGS', 'Expand DGGS')
    ...
    def icon(self):
        return QIcon(os.path.join(os.path.dirname(os.path.dirname(__file__)), '../images/conversion/expanddggs.png'))
    ...
    txt_en = 'Expand DGGS'
    txt_vi = 'Expand DGGS'
    figure = '../images/tutorial/expanddggs.png'
