...
class BinISEA4T(QgsProcessingAlgorithm):
    INPUT = 'INPUT'
    ...
    def processAlgorithm(self, parameters, context, feedback):   
        if (platform.system() == 'Windows'):
            ...
            for i, point_feature in enumerate(self.point_layer.getFeatures()):
                ...
                append_stats_value(isea4t_bins, isea4t_id, props_dict, self.stats, self.numeric_field, self.category_field)
            ...
            for i, (isea4t_id, geom) in enumerate(isea4t_geometries.items()):
                ...
                isea4t_feature.setAttributes([props.get(f.name(), None) if f.name() != 'isea4t' else isea4t_id for f in out_fields])
