...
from ...utils.resampling.dggsgrid import generate_h3_grid


class H3Bin(QgsProcessingFeatureBasedAlgorithm):
    INPUT = "INPUT"
    ...
    def initParameters(self, config=None):
        ...
        min_res, max_res, default_res = settings.getResolution("H3")
        self.addParameter(
            QgsProcessingParameterNumber(
                self.RESOLUTION,
