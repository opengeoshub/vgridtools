...
from ...utils.binning.bin_helper import rhealpix_num_edges
...
class rHEALPixBin(QgsProcessingAlgorithm):
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        return run_vgrid_grid_bin(
            ...
            grid_generator=rhealpix_grid_within_bbox,
            id_field="rhealpix",
            metric_kind="geodesic",
            num_edges_fn=lambda cell_id, _geom: rhealpix_num_edges(cell_id),
        )
