...
class DGGALRTEA3HGrid(QObject):
    def __init__(self, vgridtools, canvas, iface):
        ...
        # Initialize DGGAL instance for rtea3h type
        self.dggs_type = "rtea3h"
